...
func (in *DpuOperatorConfigSpec) DeepCopyInto(out *DpuOperatorConfigSpec) {
	*out = *in
	if in.VspImages != nil {
		in, out := &in.VspImages, &out.VspImages
		*out = make([]VspImage, len(*in))
		copy(*out, *in)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VspImage) DeepCopyInto(out *VspImage) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VspImage.
func (in *VspImage) DeepCopy() *VspImage {
	if in == nil {
		return nil
	}
	out := new(VspImage)
